...
const firebaseConfig = {
    apiKey: "AIzaSyCAAw6bUOAtXm-GwZGgI_KquAsl96TU7ss",
    authDomain: "cv-oskar-jablonski76182.firebaseapp.com",
    projectId: "cv-oskar-jablonski76182",
    storageBucket: "cv-oskar-jablonski76182.firebasestorage.app",
    messagingSenderId: "866170249493",
    appId: "1:866170249493:web:ea144eac89a9f7ee0e891c",
    measurementId: "G-YCEFFHM970"
};
...
form.addEventListener("submit", async function (event) {
    ...
    try {
        ...
        // zapis do Firestore
        await addDoc(collection(db, "kontakty"), dane);

        // komunikat sukcesu
        alert("Dane zostały wysłane do Firebase!");
